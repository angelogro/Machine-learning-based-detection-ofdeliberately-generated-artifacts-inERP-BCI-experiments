...
def scalpmap(mnt, v, clim='minmax', cb_label='',clab=None,ax=None,setcbar=False,cmap='jet'): 
    '''
    Usage:
    ...
    if ax ==None:
        ...
        pcm=ax.imshow(zi, vmin=vmin, vmax=vmax, origin='lower', extent=[-1, 1, -1, 1], cmap=cmap)
